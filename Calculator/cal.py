...
btn_equal = tk.Button(root, text='=', command=evaluate_calculator, width=11, font=('Arial', 14))
btn_equal.grid(row=6, column=3, columnspan=2)
btn_clear = tk.Button(root, text='C', command=clear_field, width=11, font=('Arial', 14))
btn_clear.grid(row=6, column=1, columnspan=2)
# btn_dot = tk.Button(root, text='.', command=lambda: add_to_calculator('.'), width=5, font=('Arial', 14))
# btn_dot.grid(row=7, column=1)
